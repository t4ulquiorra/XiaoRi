...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/XiaoRiApp/workflows/nightly.yml/main/xiaori-gms-nightly.zip"
        } else {
            "https://github.com/XiaoRiApp/Echo-Music/releases/download/$versionName/xiaori.apk"
        }
