...
fun PlayerSettings(
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = com.xiaori.constants.DownloadQuality.values().toList(),
            valueText = {
                when (it) {
    ...
    Column(
        ...
        Material3SettingsGroup(
            ...
            items = buildList {
                ...
                add(Material3SettingsItem(
                    icon = painterResource(R.drawable.xiaoriequlizer),
                    title = { Text(stringResource(R.string.xiaori_equalizer)) },
                    description = { Text(stringResource(R.string.xiaori_equalizer_desc)) },
