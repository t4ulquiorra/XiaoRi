...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/XiaoRiApp/Echo-Music/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "XiaoRi Server",
                url = "wss://t4ulquiorra-xiaori.hf.space/ws",
                location = "Global",
                operator = "ECHO"
            )
        )
