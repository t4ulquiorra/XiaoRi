                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/XiaoRiApp/Echo-Music/releases/download/${currentStatus.version}/xiaori.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/XiaoRiApp/Echo-Music/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/XiaoRiApp/Echo-Music/releases/download/$tagWithPrefix/changelog.json")
